...
import {UDID_abi, UDID_Addr,WhiteUDID_abi,WhiteUDID_Addr,Mint_abi,Mint_Addr } from "./abi_address.js"
...
function attachEvents() {
    ...
    $("#exchange").click(async () => {
        try {
            ...
            let res = await window.app.mt.methods.getTokenList(0).call({from: window.app.current_account})
